...
public record class ScrFunction : IExportedSymbol
{
    ...
    public string Documentation
    {
        get
        {
            ...
            // Autogenerated API functions don't show "function" keyword
            // Script functions show the "function" keyword
            string functionKeyword = IsAutogenerated ? string.Empty : "function ";
    ...
    {
        // Autogenerated API functions show CalledOn in the signature, so don't repeat it in parameters section
        // Script functions don't show CalledOn in signature, so include it in parameters section
        var calledOn = IsAutogenerated ? null : Overloads.First().CalledOn;
    ...
    /// <summary>
    /// Whether this function is autogenerated (code API function).
    /// </summary>
    public bool IsAutogenerated => Flags.Contains("autogenerated", StringComparer.OrdinalIgnoreCase);
}
